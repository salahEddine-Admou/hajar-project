...
const STRINGS = {
  en: {
    ...
    addBaby: 'Add child', birthDate: 'Birth date', sex: 'Sex', male: 'Boy', female: 'Girl', deliveryType: 'Delivery', vaginal: 'Vaginal', cesarean: 'C-section', addGrowth: 'Add measurement', date: 'Date', notes: 'Notes', noBabies: 'Add your first child to start tracking.',
  ...
  fr: {
    ...
    addBaby: 'Ajouter un enfant', birthDate: 'Date de naissance', sex: 'Sexe', male: 'Garçon', female: 'Fille', deliveryType: 'Accouchement', vaginal: 'Voie basse', cesarean: 'Césarienne', addGrowth: 'Ajouter une mesure', date: 'Date', notes: 'Notes', noBabies: 'Ajoutez votre premier enfant pour commencer le suivi.',
  ...
  ar: {
    ...
    addBaby: 'إضافة طفل', birthDate: 'تاريخ الميلاد', sex: 'الجنس', male: 'ذكر', female: 'أنثى', deliveryType: 'نوع الولادة', vaginal: 'طبيعية', cesarean: 'قيصرية', addGrowth: 'إضافة قياس', date: 'التاريخ', notes: 'ملاحظات', noBabies: 'أضيفي طفلك الأول لبدء المتابعة.',
